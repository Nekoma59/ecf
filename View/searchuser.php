...
{
    $searchstr=$_POST["nom"];
    var_dump($searchstr); // debug statement
    $searchuser = $userC->showuserr($searchstr);
    //$searchuser = $userC->showuserr($_POST["nom"]);
}
?>
<style>
    .output {
...
<body>
  ...
  <a href="backuser.php"class="icon-a"><i class="fa fa-users icons"></i> &nbsp;&nbsp;Gestion utilisateurs</a>
            ...
            <a href="searchuser.php">
              <i class="bi bi-circle"></i><span>Rechercher utilisateurs</span>
            </a>
...
<span style="font-size:30px;cursor:pointer; color: white;" class="nav2"  >&#9776;Gestion utilisateurs </span>
	...
	<div class="col-div-8">
			...
			<h1  style="color:white">Rechercher utilisateurs à partir du nom </h1>
